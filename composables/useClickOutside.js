 ...
 * @returns 
 */
export async function useClickOutside (el_target_ref, on_click_outside, callback_condition){
    if ( ! el_target_ref ) return; 
    if ( ! el_target_ref.value ){
        // console.log ("useClickOutside", "target element was not supplied or is null")
        // return 
    }
    
    var dont_use_first_click = 1;
